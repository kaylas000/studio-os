...
export const FLEET: Unit[] = [
  ...
  { id: 'agp-16', category: 'aerial', model: 'АГП-16 на ISUZU ELF, компактная', maker: 'Клинцы', year: 2019, reach: 16, capacity: 0.3, shift: 14200, extraHour: 1250, minOrder: 1, minHours: 2, hours: 3120, outreach: 'Вверх 16 м, вбок 16,5 м за счёт поворота люльки — 5-этажка, проём звонницы, карниз коттеджа в зазоре между пристройками', ground: 'Высота проезда 2,8 м; с компрессором стравливаем шины и проходим ниже. Вывешивание на 4 лапы, под них плиты — работаем по плитке и газону', crew: 1, photo: 'aerial-16', photoRatio: '3/4', available: 2, total: 3 },
